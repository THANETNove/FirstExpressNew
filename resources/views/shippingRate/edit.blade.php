                        ...
                        <div class="col-12">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-contact" role="tabpanel"
                                    ...
                                    <section class="content">
                                        <!-- Default box -->
                                    <form method="POST" action="{{ route('shipping-rate.update',$data->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="card">
                                                ...
                                                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                                <table id="" class="table  table-borderless">
                                                                    ...
                                                                    <tbody>
                                                                            ...
                                                                            <td>
                                                                                <div class="container">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        @enderror
                                                                                        <div class="col">
                                                                                            <input t type="number" min="1" value="{{$data->weightMax7}}" class="form-control @error('weightMax7') is-invalid @enderror"  name="weightMax7" placeholder="20">
                                                                                        </div>
                                                                                        @error('weightMax7')
                                                                                            <span class="invalid-feedback" role="alert">
                                                                                                <strong>{{ $message }}</strong>
                                                                        ...
                                                                        <tr class="odd">
                                                                            ...
                                                                            @enderror
                                                                            <td>
                                                                                <input  type="number" min="1" min="1" class="form-control  @error('sellingPriceUpcountry8') is-invalid @enderror"  value="{{$data->sellingPriceUpcountry8}}" name="sellingPriceUpcountry8" placeholder="20">
                                                                            </td>
                                                                ...
                                                                <div class="">
                                                                    <button type="submit" class="btn butt-save"> {{ __(' เเก้ไขเรทราคา') }}</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
