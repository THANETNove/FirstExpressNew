                                                                ...
                                                                <table id="" class="table  table-borderless">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr class="odd">
                                                                            ...
                                                                            @enderror
                                                                            <td>
                                                                                <input type="number" min="1" class="form-control  @error('sellingPriceBangkok4') is-invalid @enderror" value=""  name="sellingPriceBangkok4" placeholder="20">
                                                                            </td>
                                                                        ...
                                                                        <tr class="odd">
                                                                            <td>
                                                                                <div class="container">
                                                                                    <div class="row">
                                                                                        <div class="col">
                                                                                            <input type="number" min="1" value="" class="form-control @error('weightMin6') is-invalid @enderror" name="weightMin6" placeholder="1001">
                                                                                        </div>-
                                                                                        @error('weightMin6')
                                                                                            <span class="invalid-feedback" role="alert">
                                                                                                <strong>{{ $message }}</strong>
